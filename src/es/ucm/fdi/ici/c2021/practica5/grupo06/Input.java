...
/**
 * Interface to obtain the input variables required to evaluate the fuzzy over
 * the game.
 * 
...
public interface Input {
	...
	/**
	 * Obtains the required variables from the game and stores them as attributes of
